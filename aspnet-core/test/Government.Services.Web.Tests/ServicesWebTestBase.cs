...
{
    public abstract class ServicesWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ServicesWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ServicesWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ServicesDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ServicesDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ServicesDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ServicesDbContext, Task<T>> func)
        {
            T result;
